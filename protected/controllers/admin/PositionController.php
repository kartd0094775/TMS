...
class PositionController extends ControllerAdminCrud {
	...
	public function actionOutside() {
		...
		$c -> select = 'gpsLat, gpsLng';
		// $c -> order = 'RAND()';
		$c -> condition = 'gpsLat != 999 OR gpsLng != 999 OR deviceID != :deviceID';
		$c -> params = array(':deviceID' => 'n/a');
