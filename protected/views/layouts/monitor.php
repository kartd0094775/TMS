				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						-->
							...
							<li class="iconRead" >
								<a href="<?php print $this -> getUrl('list', 'icon'); ?>"> <i class="fa fa-user-md fa-fw"></i> <span t>Icon Management
								</span></a>
							</li>
...
<li class="positionRead">
								<a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Position Log<span class="fa arrow"></span></a>
							...
							<li class="position2Read" >
								<a href="<?php print $this -> getUrl('list', 'position2'); ?>"> <i class="fa fa-cab"></i> Position Log2</a>
							</li>
							<li class="statisticsRead" >
								<a href="<?php print $this -> getUrl('list', 'statistics'); ?>"> <i class="fa fa-cab"></i> 使用者數量/調用次數</a>
							</li>
