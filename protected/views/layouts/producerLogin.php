		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					...
					<!-- <img src="<?php print $b; ?>/img/logo.gif" style="max-width:100%" /> -->
					
					
					<div class="login-panel panel panel-default" style="margin-top:20px">
						<div class="panel-heading">
							<h3 class="panel-title"> Sign In as PRODUCER </h3>
						</div>
						<div class="panel-body">
							<form role="form" method="post" action="<?php print $this -> url('producerLoginDo'); ?>">
