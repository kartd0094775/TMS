...
<head>
	...
	<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
		...
		print 'var producerID = "' . $this -> producerID . '";';
		...
		<div id="wrapper">
			...
			<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="<?php print $adminUrl; ?>/dashboard">PRODUCER</a>
				</div>
				<!-- /.navbar-header -->
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li>
								...
								<a href="#"><i class="fa fa-user fa-fw"></i> <?php print $this -> producer['name']; ?></a>
							</li>
							<li>
					...
					<ul class="nav" id="side-menu">
						...
						-->
							...
							<li class="adminRead" >
								...
								<a href="<?php print $this -> getUrl('list', 'product'); ?>"> <i class="fa fa-user-md fa-fw"></i> <span t>Product Management
								</span></a>
							</li>
							
							
								<li class="floorRead" >
								<a href="<?php print $this -> getUrl('list', 'coupon'); ?>"> <i class="fa fa-user-md fa-fw"></i> <span t>Coupon Management
								</span></a>
							</li>
							
								<li class="companyRead" >
								<a href="<?php print $this -> getUrl('list', 'event'); ?>"> <i class="fa fa-user-md fa-fw"></i> <span t>Event Management
								</span></a>
							</li>
...
<li>
                        ...
                        <li  >
                        	<a href="<?php print $b; ?>/site/producerLogoutDo"> <i class="fa fa-sign-out fa-fw"></i> <span t>Logout</span></a>
                        </li>
