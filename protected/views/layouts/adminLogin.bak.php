			...
			<div class="row">
				...
				<div id="content" class="col-md-12 full-page login">
					...
					<div class="inside-block">
						<img src="<?php print $baseUrl; ?>/assetsAdmin/images/logo-big.png" alt class="logo">
						<!-- <h1><strong>Welcome</strong> Stranger</h1> -->
						<h1><strong>Admin</strong></h1>
						<!-- <h5>Minimal Admin Theme</h5> -->

						<form id="form-signin" class="form-signin" method="post" action="<?php print $this -> url('adminLoginDo'); ?>">
							<section>
