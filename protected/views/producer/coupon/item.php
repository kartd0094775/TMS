...
<div class="pageheader">
	...
	<h2><i class="fa fa-file-o" style="line-height: 48px;padding-left: 2px;"></i><span t>Coupon Detail</span></h2>
	...
	<section class="tile color transparent-black">
		...
		<div class="tile-body">
			...
			<form role="form" class="form-horizontal" parsley-validate id="form" method="post" action="<?php print $this -> url('updateDo'); ?>" enctype="multipart/form-data" >
				...
				<div class="form-group">
					<label for="fullname" class="col-sm-2 control-label" ><span t>賣出數量</span></label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea type="text" class="form-control" name="description" style="height:150px"  />
						</textarea>
					</div>
				</div>

				<div class="form-group">
					<label for="fullname" class="col-sm-2 control-label" ><span t>原價</span></label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="originPrice"  />
					</div>
				</div>

				<div class="form-group">
					<label for="fullname" class="col-sm-2 control-label" ><span t>特價</span></label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="specialPrice"  />
					</div>
				</div>
...
if (isset($item)) {
	...
	$data['photo'] = '<img src="' . $b . '/upload/' . 'product' . '/' . $data['photo'] . '" class="thumb">';
