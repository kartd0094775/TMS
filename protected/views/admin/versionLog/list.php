...
<div class="pageheader">
	...
	<h2><i class="fa fa-file-o" style="line-height: 48px;padding-left: 2px;"></i> Version list</h2>
					...
					<table class="table table-bordered table-sortable table-striped">
						<thead>
							<tr>
								...
								<th class="sortable sort-alpha" orderField="code" style="width:60px">MD5</th>
								<th class="sortable sort-alpha" orderField="name">Version</th>
								<th class="sortable sort-alpha" orderField="file">Changed</th>
							...
							<tr>
								...
								<th >
								<input type="text" class="form-control search" name="version" />
								</th>
								<th >
								<input type="text" class="form-control search" name="file" />
								</th>
