...
<div class="pageheader">
	...
	<h2><i class="fa fa-file-o" style="line-height: 48px;padding-left: 2px;"></i><span t>Banner管理</span></h2>
...
<script>
	function getListHtml(data) {
		...
		for (var i in data) {
			...
			html += '<td>' + v(x['id']) + '</td>';
			html += '<td><a href="' + baseUrl + '/banner/item?id=' + x['id'] + '" target="_blank">' + v(x['name']) + '</a></td>';
