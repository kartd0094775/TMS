...
<div class="pageheader">
	...
	<h2><i class="fa fa-file-o" style="line-height: 48px;padding-left: 2px;"></i><span t>商家管理</span></h2>
...
<script>
	function getListHtml(data) {
		...
		for (var i in data) {
			...
			html += '<a class="btn btn-default btn-warning btn-xs read" href="' + baseUrl + '/' + 'admin/product' + '/list?id=' + x['id'] + '" t>商品列表</a> ';

			//html += '<a class="btn btn-default btn-primary btn-xs read" href="' + baseUrl + '/' + 'admin/producerUrl' + '/list?id=' + x['id'] + '" t>商品網址</a> ';
