...
<div class="pageheader">
	...
	<h2><i class="fa fa-file-o" style="line-height: 48px;padding-left: 2px;"></i> Position Log 2</h2>
					...
					<table class="table table-bordered table-sortable table-striped">
						<thead>
							<tr>
								...
								<th class="sortable sort-alpha" orderField="dataJson">data</th>
