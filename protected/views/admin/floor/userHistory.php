...
<div class="pageheader">
	...
	<h2><i class="fa fa-file-o" style="line-height: 48px;padding-left: 2px;"></i> Floor History Tracking</h2>
	...
	<section class="tile color transparent-black">
		...
		<div class="tile-body">
			...
			<form role="form" class="form-horizontal" parsley-validate id="form" method="post" enctype="multipart/form-data" >
				...
				<div class="form-group">
					<label for="fullname" class="col-sm-2 control-label" ><span t>Date</span></label>
					<div class="col-sm-10" >
						<div class="form-control fieldDisplay">
				...
				<div class="form-group">
					...
					<div class="col-sm-2 text-right ">
						<label for="fullname" class=" control-label" ><span t>Tracking List</span></label>
...
?>
<script>
	function showTimeItem(id) {

		var data = historyData[id];

		// log(data);

		var xx = parseFloat(data['x']);
		var yy = parseFloat(data['y']);
		...
		var html = '<div class="personIcon" id="personIcon_' + id + '" style="left:' + xx + 'px;top:' + yy + 'px;background:#' + backgroundColor + ';color:#' + textColor + '" >';
