...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="<?php print $b; ?>/svg-edit-2.7/jgraduate/css/jPicker.css" type="text/css"/>
		<link rel="stylesheet" href="<?php print $b; ?>/svg-edit-2.7/jgraduate/css/jgraduate.css" type="text/css"/>
		<link rel="stylesheet" href="<?php print $b; ?>/svg-edit-2.7/svg-editor.css" type="text/css"/>
		<link rel="stylesheet" href="<?php print $b; ?>/svg-edit-2.7/spinbtn/JQuerySpinBtn.css" type="text/css"/>
		...
		<script src="<?php print $b; ?>/svg-edit-2.7/jquery.js"></script>
		<script src="<?php print $b; ?>/svg-edit-2.7/pathseg.js"></script>
		<!--{endif}-->

		<script src="<?php print $b; ?>/svg-edit-2.7/js-hotkeys/jquery.hotkeys.min.js"></script>
		<script src="<?php print $b; ?>/svg-edit-2.7/jquerybbq/jquery.bbq.min.js"></script>
		<script src="<?php print $b; ?>/svg-edit-2.7/svgicons/jquery.svgicons.js"></script>
		<script src="<?php print $b; ?>/svg-edit-2.7/jgraduate/jquery.jgraduate.min.js"></script>
		<script src="<?php print $b; ?>/svg-edit-2.7/spinbtn/JQuerySpinBtn.min.js"></script>
		<script src="<?php print $b; ?>/svg-edit-2.7/touch.js"></script>

		<!--{if svg_edit_release}-->

		<script src="<?php print $b; ?>/svg-edit-2.7/svgedit.compiled.js"></script>
		...
		<script src="<?php print $b; ?>/svg-edit-2.7/config.js"></script>

		<?php

		print $this -> printJson('itemID', $item['id']);
		print $this -> printJson('svg', $item['svg']);
		?>

		<script>
			svgEditor.loadFromURL(baseUrl + '/upload/floor/' + svg);
		</script>

		<!-- always minified scripts -->
		<script src="<?php print $b; ?>/svg-edit-2.7/jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>
		<script src="<?php print $b; ?>/svg-edit-2.7/jgraduate/jpicker.js"></script>
	...
	<body>
		<div id="svg_editor">
			...
			<div id="sidepanels">
				...
				<div id="sidepanel_handle" title="Drag left/right to resize side panel [X]">
					L a y e r s
				</div>
			</div>
			...
			<div id="main_button">
				...
				<div id="main_menu">
					...
					<p>
						<a href="http://svg-edit.googlecode.com/" target="_blank"> SVG-edit Home Page </a>
					</p>
			...
			<div id="tools_top" class="tools_panel">
				...
				<div id="selected_panel">
					<div class="toolset">
						...
						<div class="tool_sep"></div>
						<label id="idLabel" title="Identify the element"> <span>id:</span>
							<input id="elem_id" class="attr_changer" data-attr="id" size="10" type="text"/>
						</label>
					</div>

					<label id="tool_angle" title="Change rotation angle" class="toolset"> <span id="angleLabel" class="icon_label"></span>
						<input id="angle" size="2" value="0" type="text"/>
					</label>

					<div class="toolset" id="tool_blur" title="Change gaussian blur value">
						<label> <span id="blurLabel" class="icon_label"></span>
					...
					<div id="xy_panel" class="toolset">
						<label> x:
							<input id="selected_x" class="attr_changer" title="Change X coordinate" size="3" data-attr="x"/>
						</label>
						<label> y:
				...
				<div id="multiselected_panel">
					...
					<label id="tool_align_relative"> <span id="relativeToLabel">relative to:</span>
				...
				<div id="rect_panel">
					<div class="toolset">
						<label id="rect_width_tool" title="Change rectangle width"> <span id="rwidthLabel" class="icon_label"></span>
							<input id="rect_width" class="attr_changer" size="3" data-attr="width"/>
						</label>
						<label id="rect_height_tool" title="Change rectangle height"> <span id="rheightLabel" class="icon_label"></span>
							<input id="rect_height" class="attr_changer" size="3" data-attr="height"/>
						</label>
					</div>
					<label id="cornerRadiusLabel" title="Change Rectangle Corner Radius" class="toolset"> <span class="icon_label"></span>
					...
					<div class="toolset">
						...
						<label id="tool_change_image">
							<button id="change_image_url" style="display:none;">
								Change Image
							</button> <span id="url_notice" title="NOTE: This image cannot be embedded. It will depend on this path to be displayed"></span> </label>
					</div>
				</div>
				...
				<div id="text_panel">
					...
					<label id="tool_font_size" title="Change Font Size"> <span id="font_sizeLabel" class="icon_label"></span>
				...
				<div id="container_panel">
					...
					<label id="group_title" title="Group identification label"> <span>label:</span>
				...
				<!-- For anchor elements -->
				<div id="a_panel">
					<label id="tool_link_url" title="Set link URL (leave empty to remove)"> <span id="linkLabel" class="icon_label"></span>
			...
			<div id="tools_bottom" class="tools_panel">
				...
				<div id="zoom_panel" class="toolset" title="Change zoom level">
					<label> <span id="zoomLabel" class="zoom_tool icon_label"></span>
				...
				<div id="tools_bottom_2">
					<div id="color_tools">
						...
						<div class="color_tool" id="tool_opacity" title="Change selected item opacity">
							<label> <span id="group_opacityLabel" class="icon_label"></span>
		...
		<div id="svg_docprops">
			...
			<div id="svg_docprops_container">
				...
				<fieldset id="svg_docprops_docprops">
					...
					<label> <span id="svginfo_title">Title:</span>
					...
					<fieldset id="change_resolution">
						...
						<label><span id="svginfo_width">width:</span>
							<input type="text" id="canvas_width" size="6"/>
						</label>

						<label><span id="svginfo_height">height:</span>
					...
					<fieldset id="image_save_opts">
						...
						<label>
							...
							<span id="image_opt_embed">Embed data (local files)</span> </label>
						<label>
							<input type="radio" name="image_opt" value="ref"/>
							<span id="image_opt_ref">Use file reference</span> </label>
					</fieldset>
				</fieldset>
		...
		<div id="svg_prefs">
			...
			<div id="svg_prefs_container">
				...
				<fieldset>
					...
					<label><span id="svginfo_lang">Language:</span> <!-- Source: http://en.wikipedia.org/wiki/Language_names -->
					...
					<fieldset id="change_grid">
						...
						<label><span id="svginfo_grid_color">Grid color:</span>
		...
		<ul id="cmenu_canvas" class="contextMenu">
			...
			<li class="separator">
				<a href="#group">Group<span class="shortcut">G</span></a>
			</li>
			<li>
				<a href="#ungroup">Ungroup<span class="shortcut">G</span></a>
			</li>
			<li class="separator">
				<a href="#move_front">Bring to Front<span class="shortcut">SHFT+CTRL+]</span></a>
			</li>
			<li>
				<a href="#move_up">Bring Forward<span class="shortcut">CTRL+]</span></a>
			</li>
			<li>
				<a href="#move_down">Send Backward<span class="shortcut">CTRL+[</span></a>
			</li>
			<li>
				<a href="#move_back">Send to Back<span class="shortcut">SHFT+CTRL+[</span></a>
			</li>
		</ul>
