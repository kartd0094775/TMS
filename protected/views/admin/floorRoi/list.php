...
<div class="pageheader">
	...
	<h2><i class="fa fa-file-o" style="line-height: 48px;padding-left: 2px;"></i><span t>Floor ROI - <?php print $floor['name']; ?></span></h2>
	...
	<div class="breadcrumbs">
		<ol class="breadcrumb">
			...
			<li class="active" t>
				Floor ROI - <?php print $floor['name']; ?>
			</li>
		</ol>
	</div>
...
<script>
	function getListHtml(data) {
		...
		for (var i in data) {
			...
			html += '<td><img class="listThumb" src="' + baseUrl + '/upload/floor/'+v(x['photo'])+'" /></td>';
			html += '<td>' + v(x['name']) + '</td>';
