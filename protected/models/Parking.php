...
class Parking extends _Model
{
	...
	public function rules()
	{
		...
		return array(
			array('deviceTypeID', 'numerical', 'integerOnly'=>true),
			array('token, carLicense', 'length', 'max'=>255),
			array('createTime', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, token, deviceTypeID, createTime, carLicense', 'safe', 'on'=>'search'),
		);
	}
