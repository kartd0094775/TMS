...
class Event extends _Model
{
	...
	public function rules()
	{
		...
		return array(
			array('id, status, producerId, updatedat, createdat', 'required'),
			...
			array('start, end, brief, description, lotteryInitAt, lotteryRunAt, lotteryResult, approvedAt', 'safe'),
