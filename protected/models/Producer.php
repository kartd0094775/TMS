...
class Producer extends _Model
{
	...
	public function rules()
	{
		...
		return array(
			array('id, status, isSticky, account, password, name, nickname, mainType, subType, priceRange, area, address, tel, photo, photos, vacation, website, fburl, description, onsaleInformation, rightsInformation, beacon, beaconIds, openTimeWorkday, openTimeVacation, countClick, countFavor, lat, lon, isAdmin, updatedat, createdat', 'required'),
			...
			array('photo, fburl', 'length', 'max'=>1024),
